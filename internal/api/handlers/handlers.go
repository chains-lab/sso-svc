...
type App interface {
	...
	AccountUpdateRole(ctx context.Context, accountID uuid.UUID, role, initiatorRole roles.Role) error //have userID transfer
	...
	//DeleteSessionByOwner(ctx context.Context, accountID, sessionID, initiatorSessionID uuid.UUID) error
	//TerminateByAdmin(ctx context.Context, accountID, sessionID uuid.UUID) error
	//DeleteSessionByAdmin(ctx context.Context, accountID, sessionID, initiatorID, initiatorSessionID uuid.UUID) error
